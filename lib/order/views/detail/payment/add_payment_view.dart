...
import 'package:tambalin_app/order/views/detail/payment/add_price/add_price_view.dart';
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      bottomNavigationBar: Material(
        ...
        child: InkWell(
          onTap: () {
            Navigator.push(context, MaterialPageRoute(builder: ((context) => const AddPriceView())));
          },
          child: SizedBox(
            height: 12.h,
